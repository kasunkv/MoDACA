...
<div class="row">
    <div class="col-md-12">
        ...
        <h4 class="page-subheader">Add the Input Indicators for the Selected General Objective</h4>
    </div>
</div>
<!-- /. ROW  -->
<hr />
...
<div class="row">
    <div class="col-md-12">       
        <div class="col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="panel panel-default panel-shadow">
                ...
                <div class="panel-body" >                    
                        <?php echo $this->Form->create('InputIndicator', array(
                            'inputDefaults' => array(
                                //'label' => false,
                            ),
                        ));
                        ...
                        <div class="multiple-input-wrapper">
                            <div class="multi-item-wrapper">
                                <input type="hidden" name="data[0][InputIndicator][field_group_id]" value="<?php echo $student['FieldGroup']['id']; ?>" />
                                <div class="form-group input-group-lg">
                                    <select name="data[0][InputIndicator][general_objective_id]" class="form-control">
                                ...
                                <div class="form-group">
                                    <textarea name="data[0][InputIndicator][indicator]" class="form-control" placeholder="Indicator..." rows="4" cols="30" ></textarea>
                                </div>                                
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <h3>Current Input Indicators</h3>
                        ...
                        <div id="collapse<?php echo $i; ?>" class="panel-collapse collapse <?php echo $i == 1 ? 'in' : ''; ?>" style="height: auto;">
                            <div class="panel-body">
                                <?php foreach($indicators as $indicator): ?>
                                    <?php if($indicator['InputIndicator']['general_objective_id'] == $objective['GeneralObjective']['id']): ?>
                                        <div class="activity-noti panel-shadow">
                                            <p class="activity-noti-desc text-muted" style="overflow: auto; height: auto; font-size: 1.1em;"><?php echo  $indicator['InputIndicator']['indicator']; ?></p>                                                                    
                                        </div>
                                    <?php endif; ?>                                
                                <?php endforeach; ?>
                            </div>
    ...
    $('#btn-add-field').click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed           
            $('.multiple-input-wrapper').append('<div class="multi-item-wrapper animated zoomIn">\
                                <input type="hidden" name="data['+ x +'][InputIndicator][field_group_id]" value="<?php echo $student['FieldGroup']['id']; ?>" />\
                                <div class="form-group input-group-lg">\
                                    <select name="data['+ x +'][InputIndicator][general_objective_id]" class="form-control">\
                                        <option value="" selected="">Select General Objective...</option> \
                                        <?php foreach ($generalObjectives as $obj): ?>\
                                            <option value="<?php echo $obj['GeneralObjective']['id']; ?>"><?php echo $obj['GeneralObjective']['objective']; ?></option>  \
                                        <?php endforeach; ?>\
                                ...
                                <div class="form-group">\
                                    <textarea name="data['+ x +'][InputIndicator][indicator]" class="form-control" placeholder="Indicator..." rows="4" cols="30" ></textarea>\
                                </div>\
                                <div class="col-md-12">\
